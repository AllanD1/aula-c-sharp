...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:MultiView ID="MultiViewCategoria" runat="server">
        ...
        <asp:View ID="tabListagem" runat="server">
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" AllowSorting="true" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" DataKeyNames="cat_id" DataSourceID="ObjectDataSource1">
                <Columns>
                    <asp:BoundField DataField="cat_id" HeaderText="ID" Visible="false" InsertVisible="False" ReadOnly="True" SortExpression="cat_id" />
                    <asp:BoundField DataField="cat_nome" HeaderText="Categorias" SortExpression="cat_nome" />
